...
import PingButton from "@/components/manualping"
            ...
            <div className="bg-gray-800 rounded-t-lg border border-gray-700">
              ...
              <div className="flex items-center justify-between px-4 py-2 bg-gray-900 rounded-t-lg border-b border-gray-700">
                ...
                <div className="flex items-center space-x-2 text-gray-400">
                  ...
                  <span className="text-sm">auto-ping-monitor.exe</span>
                </div>
              ...
              {/* Terminal Content */}
              <div className="p-4 lg:p-6 bg-black text-green-400 min-h-[500px] lg:min-h-[600px] rounded-b-lg">
                {/* Header */}
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2 gap-2">
                    <div className="text-cyan-400 text-sm">[{formatTime(currentTime)}] user@ping-monitor:~$</div>
                ...
                <motion.div
                  ...
                  className="mb-6"
                >
                  <div className="text-cyan-400 mb-2 text-sm">{">"} ping status --monitor j15-endpoint</div>
                  ...
                  <AnimatePresence mode="wait">
                    {loading ? (
                      ...
                      >
                        ...
                        />
                        <span className="text-sm">Pinging endpoint...</span>
                      </motion.div>
                    ) : !isEnabled ? (
                      <motion.div
                        key="disabled"
                      ...
                      >
                        ...
                        <div className="text-gray-300 text-sm">Response: {pingResult.message}</div>
                        ...
                        {pingResult.data && (
                          <motion.div
                            ...
                            className="mt-4"
                          >
                            <div className="text-cyan-400 mb-2 text-sm">{">"} cat response.json</div>
                            <div className="bg-gray-900 border border-gray-700 rounded p-3 overflow-auto">
                              <pre className="text-green-300 text-xs">{JSON.stringify(pingResult.data, null, 2)}</pre>
                            </div>
                          </motion.div>
                        )}
                      </motion.div>
                ...
                >
                  <span className="text-cyan-400 text-sm">user@ping-monitor:~$</span>
                  <motion.span animate={{ opacity: showCursor ? 1 : 0 }} className="bg-green-400 text-black px-1">
                    _
                  </motion.span>
                </motion.div>
